...
void CipherMasked(state_t *state, const uint8_t *RoundKey)
{
...
void CipherMasked_round(state_t *state, const uint8_t *RoundKey, uint8_t round)
{
    uint8_t RoundKeyMasked[AES_keyExpSize] = {0};
    uint8_t mask[10] = {0};
...
void aes_run(uint8_t *state, uint8_t *key)
{
    struct AES_ctx ctx;
