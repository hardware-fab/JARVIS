...
void SEED_intermediateR1(const unsigned char s[SEED_BLOCK_SIZE],
                         unsigned char d[SEED_BLOCK_SIZE],
                         unsigned char r1[SEED_BLOCK_SIZE / 2],
                         const SEED_KEY_SCHEDULE *ks)
{
  seed_word x1, x2, x3, x4;
  seed_word t0, t1;
...
unsigned char key[SEED_KEY_LENGTH] = {0x2b, 0x7e, 0x15, 0x16, 0x28, 0xae, 0xd2, 0xa6, 0xab, 0xf7, 0x15, 0x88, 0x09, 0xcf, 0x4f, 0x3c};
uint8_t state[SEED_BLOCK_SIZE] = {0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41};
int iterDelay;
